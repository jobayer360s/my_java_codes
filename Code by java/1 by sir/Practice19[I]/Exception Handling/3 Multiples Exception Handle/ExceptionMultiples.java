...
public class ExceptionMultiples
{
	private int x, y;
	private String s;
	public static void main(String args[])
	{
		...
		ExceptionMultiples ed = new ExceptionMultiples();
		...
		catch(ArithmeticException ae)
		{
			...
			ae.printStackTrace(); //showing the line number & class name where exception occures
			ed.y = 1;
		}
